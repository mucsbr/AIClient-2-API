...
const translations = {
    'zh-CN': {
        ...
        'oauth.kiro.amq2apiSync': '从 amq2api 同步',
        'oauth.kiro.amq2apiSyncDesc': '从远程 amq2api 服务器同步 Kiro 账号',
        'oauth.kiro.amq2apiSyncInstructions': '输入 amq2api 服务器地址和 Admin Key，系统将自动获取并导入 amazonq 类型的账号。',
        'oauth.kiro.amq2apiUrl': '服务器地址',
        'oauth.kiro.amq2apiUrlHint': '例如: http://example.com:12380',
        'oauth.kiro.amq2apiAdminKey': 'Admin Key',
        'oauth.kiro.amq2apiUrlRequired': '请输入服务器地址',
        'oauth.kiro.amq2apiAdminKeyRequired': '请输入 Admin Key',
        'oauth.kiro.amq2apiStartSync': '开始同步',
        'oauth.kiro.amq2apiSyncing': '同步中...',
        'oauth.kiro.amq2apiFetching': '正在获取账号列表...',
        'oauth.kiro.amq2apiFoundAccounts': '找到 {count} 个账号',
        'oauth.kiro.amq2apiImporting': '正在导入 {current}/{total}...',
        'oauth.kiro.amq2apiComplete': '同步完成',
        'oauth.kiro.amq2apiSyncComplete': '同步完成！',
        'oauth.kiro.amq2apiSyncFailed': '同步失败',
        'oauth.kiro.amq2apiFetchAccounts': '获取账号列表',
        'oauth.kiro.amq2apiNoAccounts': '没有找到 amazonq 类型的账号',
        'oauth.kiro.amq2apiNoSelected': '请至少选择一个账号',
        'oauth.kiro.amq2apiSelectedStats': '已选择 {selected} / {total} 个账号',
        'oauth.kiro.selectAll': '全选',
        'oauth.kiro.selectNone': '全不选',
        'oauth.kiro.selectEnabled': '只选启用',
        'oauth.kiro.enabled': '已启用',
        'oauth.kiro.disabled': '已禁用',
        'oauth.kiro.lastRefresh': '上次刷新',
        'oauth.kiro.back': '返回',
        'oauth.kiro.success': '成功',
        'oauth.kiro.duplicate': '重复',
        'oauth.kiro.failed': '失败',
    ...
    'en-US': {
        ...
        'oauth.kiro.amq2apiSync': 'Sync from amq2api',
        'oauth.kiro.amq2apiSyncDesc': 'Sync Kiro accounts from remote amq2api server',
        'oauth.kiro.amq2apiSyncInstructions': 'Enter the amq2api server URL and Admin Key. The system will automatically fetch and import amazonq type accounts.',
        'oauth.kiro.amq2apiUrl': 'Server URL',
        'oauth.kiro.amq2apiUrlHint': 'e.g., http://example.com:12380',
        'oauth.kiro.amq2apiAdminKey': 'Admin Key',
        'oauth.kiro.amq2apiUrlRequired': 'Please enter server URL',
        'oauth.kiro.amq2apiAdminKeyRequired': 'Please enter Admin Key',
        'oauth.kiro.amq2apiStartSync': 'Start Sync',
        'oauth.kiro.amq2apiSyncing': 'Syncing...',
        'oauth.kiro.amq2apiFetching': 'Fetching account list...',
        'oauth.kiro.amq2apiFoundAccounts': 'Found {count} accounts',
        'oauth.kiro.amq2apiImporting': 'Importing {current}/{total}...',
        'oauth.kiro.amq2apiComplete': 'Sync complete',
        'oauth.kiro.amq2apiSyncComplete': 'Sync complete!',
        'oauth.kiro.amq2apiSyncFailed': 'Sync failed',
        'oauth.kiro.amq2apiFetchAccounts': 'Fetch Accounts',
        'oauth.kiro.amq2apiNoAccounts': 'No amazonq accounts found',
        'oauth.kiro.amq2apiNoSelected': 'Please select at least one account',
        'oauth.kiro.amq2apiSelectedStats': 'Selected {selected} / {total} accounts',
        'oauth.kiro.selectAll': 'Select All',
        'oauth.kiro.selectNone': 'Select None',
        'oauth.kiro.selectEnabled': 'Select Enabled',
        'oauth.kiro.enabled': 'Enabled',
        'oauth.kiro.disabled': 'Disabled',
        'oauth.kiro.lastRefresh': 'Last refresh',
        'oauth.kiro.back': 'Back',
        'oauth.kiro.success': 'Success',
        'oauth.kiro.duplicate': 'Duplicate',
        'oauth.kiro.failed': 'Failed',
        'oauth.kiro.builderIDStartURL': 'Builder ID Start URL',
